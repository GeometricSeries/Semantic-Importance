...
axis([1,inf,0,inf])
legend('Conventional Mode','Semantic Mode (SNR=-15dB)','Semantic Mode (SNR=-10dB)','Semantic Mode (SNR=-5dB)','Semantic Mode (SNR=0dB)','Semantic Mode (SNR=5dB)','Semantic Mode (SNR=10dB)','location','Southeast','FontName','Times New Roman','FontSize',11,'LineWidth',1.5);
